...
static const gc9a01_cmd_t gc9a01_init_cmds[] {
    ...
    {0x8e, {0xff}, 1},
    {0x8f, {0xff}, 1},
    {CMD_DISPLAY_FUNCTION_CTRL, {0x00,0x20}, 2},  // Scan direction S360 -> S1
    // {CMD_MEM_ACCESS_CTL,{0x08},1},           //MemAccessModeSet(0, 0, 0, 1);
    // {CMD_PIXEL_FORMAT_SET,{ColorMode_MCU_16bit&0x77},1},
    {0x90, {0x08,0x08,0x08,0x08}, 4},
    {0xbd, {0x06}, 1},
    {0xbc, {0x00}, 1},
    {0xff, {0x60,0x01,0x04}, 3},
    {CMD_VREG1A_VOLTAGE_CTRL, {0x13}, 1},
    {CMD_VREG1B_VOLTAGE_CTRL, {0x13}, 1},
    {CMD_VREG2A_VOLTAGE_CTRL, {0x22}, 1},
    {0xbe, {0x11}, 1},
    {0xe1, {0x10,0x0e}, 2},
    {0xdf, {0x21,0x0c,0x02}, 3},
    {CMD_SET_GAMMA_1, {0x45,0x09,0x08,0x08,0x26,0x2a}, 6},
    {CMD_SET_GAMMA_2, {0x43,0x70,0x72,0x36,0x37,0x6f}, 6},
    {CMD_SET_GAMMA_3, {0x45,0x09,0x08,0x08,0x26,0x2a}, 6},
    {CMD_SET_GAMMA_4, {0x43,0x70,0x72,0x36,0x37,0x6f}, 6},
    {0xed, {0x1b,0x0b}, 2},
    {0xae, {0x77}, 1},
    {0xcd, {0x63}, 1},
    ...
    {0x98, {0x3e,0x07}, 2},
    {CMD_TEARING_ON, {0}, 0},// Tearing effect line on
    {0, {0}, 0xff},//END
};
